...
driver = webdriver.Chrome(service=Service(r"C:\Users\mykal\Desktop\chromedriver-win64\chromedriver.exe"), options=chrome_options)
...
try:
    ...
    if os.path.exists(COOKIES_FILE):
        ...
        driver.get("https://www.facebook.com/")
        time.sleep(2)
        driver.find_element(By.ID, "email").send_keys("alisser594@gmail.com")
        driver.find_element(By.ID, "pass").send_keys("Mykal@_[Steele]25122005" + Keys.RETURN)
    ...
    driver.get("hhttps://www.facebook.com/KMUTT/photos")
    time.sleep(5)
