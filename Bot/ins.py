...
try:
    ...
    if os.path.exists(COOKIES_FILE):
        ...
        time.sleep(3)
        driver.find_element(By.NAME, "username").send_keys("")  # Replace with your Instagram username
        driver.find_element(By.NAME, "password").send_keys("" + Keys.RETURN)  # Replace with your Instagram password
